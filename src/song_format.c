...
gcc_pure
static const char *
song_value1(const struct mpd_song *song, const struct mpd_status *status, const char *name)
{
	static char buffer[40];
	const char *value;
...
static const char *
song_getter1(const void *object, const void *object1, const char *name)
{
	return song_value1((const struct mpd_song *)object, (const struct mpd_status *)object1, name);
}

char *
format_song1(const struct mpd_song *song, const struct mpd_status *status, const char *format)
{
	return format_object1(format, song, status, song_getter1);
}